        ...
        <React.Fragment>
            ...
            <footer className="section has-background-black-ter">
                <div className="container">
                    <div className="columns">
                        <div className="column is-12">
                            <Link to="/posts" href="/PostList">
                                <a>
                                    Go to Post List Page <span>></span>
                                </a>
                            </Link>
                        </div>
                    </div>
